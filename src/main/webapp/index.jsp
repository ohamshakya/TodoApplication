...
<html>
    ...
    <body>
        ...
        <h1 class="mt-20">Welcome! <%= firstName %></h1>
        <%} else {%>
        <%
        ...
        %>
        <a href="todoform.jsp" >
            <button type="button" class="outline outline-offset-2 outline-1 border-green">Add Todo</button>
        </a>
        <%         
                ...
                <tbody>
                    ...
                    <tr class="border-t border-gray-200 hover:bg-gray-50">
                        ...
                        <td class="py-3 px-4 border border">
                            <a class="bg-yellow-300 outline outline-offset-2 outline-1 outline-yellow-600 text-black" href="editTodo.jsp?id=<%= td.getId()%>&userId=<%= td.getUserId()%>" >Edit</a> | 
                            <a class="bg-red-900 outline outline-offset-2 outline-1 outline-red-900 text-black"  href="deleteTodo.jsp?id=<%= td.getId()%>&userId=<%= td.getUserId()%>">Delete</a>
                        </td>
                    </tr>
                    <%
                        }
